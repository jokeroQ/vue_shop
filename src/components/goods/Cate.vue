...
<el-tag type="warning" v-else size="mini">三级</el-tag>
    ...
    <template slot="option" slot-scope="scope">
        <el-button type="primary" size="mini"  icon="el-icon-edit" @click="editCartForm(scope.row.cat_id)">编辑</el-button>
  <el-button type="danger" size="mini"  icon="el-icon-delete" @click="deleteCartForm(scope.row.cat_id)">删除</el-button>
    </template>
</tree-table>
    <!-- 分页区 -->
    <el-pagination
...
<el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="addCateDialogClosed">
  <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
    ...
    :props="cascaderProps"
    @change="pareneCateChanged" clearable change-on-select></el-cascader>
    </el-form-item>
  </el-form>
